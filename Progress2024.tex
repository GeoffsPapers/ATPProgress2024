...
The acronyms for problem types are listed in Section~\ref{SPCs}.
The 1.00/0.00 columns gives the number of problems with rating 1.00 in TPTP v6.3.0, and the number
of problems with rating 0.00 in v8.2.0.
...
& 1042 1044 & 155 598 \\
{\tt CNF\_*\_EPR\_*} &
Unsatisfiable and satisfiable sets of effectively propositional (EPR) Horn and non-Horn clauses.
Un/Satisfiable sets are coherent because EPR sets are decidable.
& 888 897 & 69 780 \\
{\tt FOF\_THM\_RFO\_*} &
