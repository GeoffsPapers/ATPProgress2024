...
progress, normalized by the number of previously unsolved problems so that 0.0 means no 
previously unsolved problems were solved and 1.0 means all previously unsolved problems were 
solved. 
Peaks indicate stronger progress.
...
The figure plotted the average ratings for the 14527 problems that were unchanged in the 
...
Figure~\ref{Ratings_v6.3.0_v8.2.0} shows the same done at TPTP release v8.2.0, for the 16236 
problems that were unchanged in the TPTP since v6.3.0, and whose ratings have not been stuck at 
0.00 or 1.00 since v6.3.0.
