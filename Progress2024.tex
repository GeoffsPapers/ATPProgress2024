...
Following that (non-temporal) Shapley analysis \cite{FK+16} is used to identify which of 
the individual ATP systems made strong contributions to those strong SotA systems.
Finally (LARS TO SUGGEST THE RIGHT WORDS) GLOBAL? temporal Shapley analysis is used to analyse the 
progress of the individual systems to expose their specific contributions, particularly the 
numbers of problems they solved and which had never been solved before.
