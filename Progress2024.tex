...
The data in the TSTP solution library provides the necessary data about ATP systems' abilities
to solve the problems in the TPTP problem library.
...
do not explicitly factor in the resources, e.g., hardware, time limits, etc., needed to find 
solutions -- Section~\ref{ResourceLimits} explains why this makes sense in the ATP context.
