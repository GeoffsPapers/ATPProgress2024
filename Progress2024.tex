...
\item The solution of the Robbins problem \cite{} by the specialist ATP system
      EQP \cite{McC97} in 1996, was a noteworthy success, as the problem had defied the efforts
      of the eminent mathematician Alfred Tarski \cite{HMT71}.
...
\item The first inner five-segment theorem of Tarski's geometry was first automatically proved
      by E \cite{Sch13-LPAR} in 2019, after being posed by Quaife in 1989 \cite{Qua89}.
